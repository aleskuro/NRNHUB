  ...
  useEffect(() => {
    const fetchVideos = async () => {
      ...
      try {
        ...
        const url = `${API_URL}/api/videos/category/Health`;
        ...
        const mockData = [
          {
            _id: '1',
            title: 'Test Health Video',
            embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'A test health video',
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-800">Health Videos</h1>
        ...
        {loading ? (
          ...
          <div className="flex items-center justify-center h-48 bg-white rounded-lg shadow-sm">
            <p className="text-gray-500 text-lg">No health videos available.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
