  ...
  const VideoCard = ({ video }) => {
    return (
      <div className="flex flex-col">
        ...
        <div className="w-full bg-white rounded-t-xl overflow-hidden shadow-xl" style={{
          height: '280px',
        ...
        <div className="bg-white p-4 rounded-b-xl shadow-xl border-t border-gray-100">
          <div className="flex justify-between items-start mb-2">
            ...
            <button
              onClick={(e) => handleShare(video.embedUrl)}
          ...
          <div className="mt-3 flex justify-between items-center">
            ...
            <span className="text-xs font-medium px-2 py-1 rounded-full" style={{ backgroundColor: 'rgba(119, 52, 227, 0.1)', color: '#7734E3' }}>
  ...
  const CategorySection = ({ videos, category, path, isLoading }) => (
    <div className="mb-12">
      <div className="flex justify-between items-center mb-6">
        ...
        {videos.length > 0 && category !== 'Other' && (
          <Link
            to={`/podcast/${path}`}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 pb-6 border-b border-gray-100">
          <div className="flex flex-wrap gap-4">
            {['All', 'Motivation', 'Interview', 'Video'].map((tab) => (
              <Link
                key={tab}
                to={tabRoutes[tab]} // Use the mapped route
