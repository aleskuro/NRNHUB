...
const BlogCard = ({ blog, truncateTitle, getReadTime, getAuthorName, getCategoryColor, formatDate }) => (
  ...
  >
    <div className="bg-gradient-to-br from-white to-purple-50 rounded-xl shadow-sm overflow-hidden mb-6 hover:shadow-md transition-shadow border border-purple-100">
      <div className="relative h-48 w-full"> {/* Fixed height, full width */}
        <img
...
const Lifestyle = () => {
  ...
  // Define lifestyle subcategories
  const lifestyleSubcategories = useMemo(
    () => ['CULTURE', 'ENTERTAINMENT', 'FOOD', 'TRAVEL', 'HEALTH', 'SPORTS'],
    []
  );

  // Filter blogs by Lifestyle subcategories and sort by latest
  const lifestyleBlogs = useMemo(
    () =>
      blogs
  ...
  // Featured blog
  const featuredBlog = lifestyleBlogs[0];
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              ...
              {renderAdSpace('lifestyleSidebar', 'Lifestyle Sidebar')}
              {renderAdSpace('lifestyleTopAd', 'Lifestyle Top')}
              <div className="bg-gradient-to-r from-[#7734E3] to-[#5E30B2] rounded-xl shadow-sm p-6 text-white mb-6">
                ...
                <p className="text-sm mb-4 text-purple-100">
                  Get the latest lifestyle updates delivered to your inbox.
                </p>
