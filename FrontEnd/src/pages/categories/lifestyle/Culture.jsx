...
const Culture = () => {
  ...
  // Filter blogs by CULTURE and sort by latest
  const cultureBlogs = useMemo(
    () =>
      blogs
  ...
  // Featured blog
  const featuredBlog = cultureBlogs[0];
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              ...
              {renderAdSpace('cultureSidebar', 'Culture Sidebar')}
              {renderAdSpace('cultureTopAd', 'Culture Top')}
              <div className="bg-gradient-to-r from-[#7734E3] to-[#5E30B2] rounded-xl shadow-sm p-6 text-white mb-6">
                ...
                <p className="text-sm mb-4 text-purple-100">
                  Get the latest cultural insights delivered to your inbox.
                </p>
