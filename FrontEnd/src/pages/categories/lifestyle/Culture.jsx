...
const Culture = () => {
  ...
  const [activeFilter, setActiveFilter] = useState('CULTURE');
  ...
  // Fetch ads on mount
  useEffect(() => {
    console.log('Fetching ads for Culture page...');
  ...
  // Debug ad state
  useEffect(() => {
    console.log('Current ads state for Culture:', {
      adImages,
      adLinks,
      visibility,
      keyAds: {
  ...
  const { cultureBlogs, featuredBlog, suggestedBlogs } = useMemo(() => {
    const filteredCultureBlogs = blogs
      .filter((blog) => blog.category?.toUpperCase() === 'CULTURE')
      .sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));

    const cultureBlogIds = new Set(filteredCultureBlogs.map((blog) => blog._id));
    const otherBlogs = blogs
      .filter((blog) => !cultureBlogIds.has(blog._id) && blog.category?.toUpperCase() !== 'CULTURE')
      .sort(() => Math.random() - 0.5)
      .slice(0, 3);

    return {
      cultureBlogs: filteredCultureBlogs,
      featuredBlog: filteredCultureBlogs[0],
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800">
      <Helmet>
        <link rel="canonical" href="http://localhost:5173/culture" />
        <title>Culture Blogs | NRNHUB</title>
        <meta
          name="description"
          content="Immerse yourself in the vibrant world of culture with our blog, featuring art, traditions, and societal trends that celebrate creativity and global heritage."
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            {!isLoading && !error && cultureBlogs.length === 0 && (
              <div className="text-center py-12 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <p className="text-gray-500">Check back later for new cultural content.</p>
              </div>
            )}
            {!isLoading && !error && cultureBlogs.length > 0 && (
            ...
            <div className="sticky top-6 space-y-8">
              ...
              <div className="bg-gradient-to-r from-[#7734E3] to-[#5E30B2] rounded-xl shadow-sm p-6 text-white">
                ...
                <p className="text-sm mb-4 text-purple-100">
                  Subscribe to receive the latest cultural insights directly in your inbox.
                </p>
