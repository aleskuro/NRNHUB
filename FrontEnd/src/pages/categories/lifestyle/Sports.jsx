...
const Sports = () => {
  ...
  // Filter blogs by SPORTS and sort by latest
  const sportsBlogs = useMemo(
    () =>
      blogs
  ...
  // Featured blog
  const featuredBlog = sportsBlogs[0];
          ...
          <div className="md:flex items-center justify-between gap-12">
            <div className="md:w-7/12 mb-10 md:mb-0 text-center md:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white leading-tight">
                Sports <span className="text-purple-200">Blog</span>
              </h1>
              <p className="text-lg md:text-xl text-purple-100 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Feel the thrill of the game with our sports blog, where athletic triumphs, team stories, and fitness tips ignite your passion. Dive into the latest updates, expert insights, and inspiring moments from the world of sports.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            {!isLoading && !error && sportsBlogs.length === 0 && (
              <div className="text-center py-12 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <p className="text-gray-500">Check back later for new sports content.</p>
              </div>
            )}
            {!isLoading && !error && sportsBlogs.length > 0 && (
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              ...
              {renderAdSpace('sportsSidebar', 'Sports Sidebar')}
              {renderAdSpace('sportsTopAd', 'Sports Top')}
