...
const Entertainment = () => {
  ...
  // Filter blogs by ENTERTAINMENT and sort by latest
  const entertainmentBlogs = useMemo(
    () =>
      blogs
        .filter((blog) => blog.category?.toUpperCase() === 'ENTERTAINMENT')
        .sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)),
    [blogs]
  );

  // Featured blog
  const featuredBlog = entertainmentBlogs[0];
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              ...
              {renderAdSpace('entertainmentSidebar', 'Entertainment Sidebar')}
              {renderAdSpace('entertainmentTopAd', 'Entertainment Top')}
              <div className="bg-gradient-to-r from-[#7734E3] to-[#5E30B2] rounded-xl shadow-sm p-6 text-white mb-6">
                ...
                <p className="text-sm mb-4 text-purple-100">
                  Get the latest entertainment updates delivered to your inbox.
                </p>
