...
const Travel = () => {
  ...
  // Filter blogs by TRAVEL and sort by latest
  ...
  // Featured blog
  const featuredBlog = travelBlogs[0];
          ...
          <div className="md:flex items-center justify-between gap-12">
            <div className="md:w-7/12 mb-10 md:mb-0 text-center md:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white leading-tight">
                Travel <span className="text-purple-200">Blog</span>
              </h1>
              <p className="text-lg md:text-xl text-purple-100 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Embark on a journey with our travel blog, where breathtaking destinations, cultural adventures, and insider tips await. Discover stories that inspire wanderlust and guide your next unforgettable trip.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              ...
              {renderAdSpace('travelSidebar', 'Travel Sidebar')}
              {renderAdSpace('travelTopAd', 'Travel Top')}
