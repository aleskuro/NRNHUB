...
const Food = () => {
  ...
  // Filter blogs by FOOD and sort by latest
  const foodBlogs = useMemo(
    () =>
      blogs
  ...
  // Featured blog
  const featuredBlog = foodBlogs[0];
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              ...
              {renderAdSpace('foodSidebar', 'Food Sidebar')}
              {renderAdSpace('foodTopAd', 'Food Top')}
              <div className="bg-gradient-to-r from-[#7734E3] to-[#5E30B2] rounded-xl shadow-sm p-6 text-white mb-6">
                ...
                <p className="text-sm mb-4 text-purple-100">
                  Get the latest food and recipe updates delivered to your inbox.
                </p>
