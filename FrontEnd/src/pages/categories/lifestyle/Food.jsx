...
const Food = () => {
  ...
  // Fetch ads on mount
  useEffect(() => {
    console.log('Fetching ads for Food page...');
  ...
  // Debug ad state
  useEffect(() => {
    console.log('Current ads state for Food:', {
      adImages,
      adLinks,
      visibility,
      keyAds: {
  ...
  const { foodBlogs, featuredBlog, suggestedBlogs } = useMemo(() => {
    const filteredFoodBlogs = blogs
      .filter((blog) => blog.category?.toUpperCase() === 'FOOD')
      .sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));

    const foodBlogIds = new Set(filteredFoodBlogs.map((blog) => blog._id));
    const otherBlogs = blogs
      .filter((blog) => !foodBlogIds.has(blog._id) && blog.category?.toUpperCase() !== 'FOOD')
      .sort(() => Math.random() - 0.5)
      .slice(0, 3);

    return {
      foodBlogs: filteredFoodBlogs,
      featuredBlog: filteredFoodBlogs[0],
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800">
      <Helmet>
        <link rel="canonical" href="http://localhost:5173/food" />
        <title>Food Blogs | NRNHUB</title>
        <meta
          name="description"
          content="Savor the flavors of the world with our food blog, featuring culinary arts, recipes, and dining experiences withbudgets to elevate your kitchen adventures."
        />
      </Helmet>
          ...
          <div className="md:flex items-center justify-between gap-12">
            <div className="md:w-7/12 mb-10 md:mb-0 text-center md:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white leading-tight">
                Food <span className="text-purple-200">Blog</span>
              </h1>
              <p className="text-lg md:text-xl text-purple-100 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Savor the flavors of the world with our food blog, where culinary arts, recipes, and dining experiences come together. Explore mouthwatering dishes, global cuisines, and tips to elevate your kitchen adventures.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            {!isLoading && !error && foodBlogs.length === 0 && (
              <div className="text-center py-12 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <p className="text-gray-500">Check back later for new food content.</p>
              </div>
            )}
            {!isLoading && !error && foodBlogs.length > 0 && (
            ...
            <div className="sticky top-6 space-y-8">
              ...
              <div className="bg-gradient-to-r from-[#7734E3] to-[#5E30B2] rounded-xl shadow-sm p-6 text-white">
                ...
                <p className="text-sm mb-4 text-purple-100">
                  Subscribe to receive the latest food and recipe updates directly in your inbox.
                </p>
