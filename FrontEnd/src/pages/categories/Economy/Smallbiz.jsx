...
const BlogCard = ({ blog, truncateTitle, getReadTime, getAuthorName, getCategoryColor, formatDate }) => (
  ...
  >
    <div className="bg-gradient-to-br from-white to-green-50 rounded-xl shadow-sm overflow-hidden mb-6 hover:shadow-md transition-shadow border border-green-100">
      ...
      <div className="p-5">
        <h3 className="text-xl font-semibold text-gray-800 mb-3 group-hover:text-[#15803D] transition-colors">
...
const Smallbiz = () => {
  ...
  // Filter blogs by SMALLBIZ and sort by latest
  const smallbizBlogs = useMemo(
    () =>
      blogs
  ...
  // Featured blog
  const featuredBlog = smallbizBlogs[0];
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800">
      {/* Hero Banner Section */}
      <div className="relative py-20 bg-gradient-to-r from-[#15803D] to-[#22C55E] overflow-hidden rounded-b-2xl">
          ...
          <div className="md:flex items-center justify-between gap-12">
            <div className="md:w-7/12 mb-10 md:mb-0 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl text-green-100 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Empower your small business with practical tips, strategies, and inspiration. Discover advice on entrepreneurship, marketing, finance, and growth to thrive in a competitive landscape.
              </p>
            </div>
            <div className="md:w-5/12 flex justify-center md:justify-end">
              {isLoading && (
                <div className="w-full max-w-sm h-64 bg-green-300/30 rounded-2xl animate-pulse flex items-center justify-center">
                  <span className="text-green-200">Loading Featured...</span>
                </div>
              )}
              {!isLoading && !featuredBlog && (
                <div className="w-full max-w-sm h-64 bg-green-300/30 rounded-2xl flex items-center justify-center">
                  <span className="text-green-200 text-center p-4">No featured article available.</span>
                </div>
              )}
              {!isLoading && featuredBlog && (
                <div className="relative w-full max-w-sm">
                  <div className="absolute -top-4 -left-4 w-24 h-24 rounded-lg border-2 border-green-300/30 hidden md:block"></div>
                  <FeaturedBlogCard
                    blog={featuredBlog}
          ...
          <div className="lg:w-2/3">
            {isLoading && (
              <div className="text-center py-12">
                <div className="animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-[#15803D] mx-auto"></div>
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
                <span className="bg-[#15803D] w-2 h-6 mr-2 rounded-sm inline-block"></span>
                Sponsored Content
              </h2>
              {renderAdSpace('smallbizSidebar', 'Small Business Sidebar')}
              {renderAdSpace('smallbizTopAd', 'Small Business Top')}
              <div className="bg-gradient-to-r from-[#15803D] to-[#22C55E] rounded-xl shadow-sm p-6 text-white mb-6">
                ...
                <form onSubmit={handleSubscribe} className="flex">
                  ...
                  <button
                    type="submit"
                    className="bg-white text-[#15803D] px-4 py-2 rounded-r-lg font-medium hover:bg-gray-100 transition-colors border-2 border-white focus:outline-none focus:ring-2 focus:ring-white"
                    disabled={isSubmitting}
                  >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex justify-center gap-4">
              <Link
                to="/market"
                className="bg-[#15803D] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#166534] transition-colors shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
                onClick={() => window.scrollTo(0, 0)}
              >
                Explore Market
              </Link>
