    ...
    return (
      <div className={`w-full bg-gray-100 rounded-xl overflow-hidden shadow-md flex items-center justify-center py-8 ${className || ''}`}>
        <div className="text-center p-6">
          ...
          <a href="/advertise" className="mt-4 inline-block text-[#15803D] hover:text-[#166534] text-sm font-medium">Learn More →</a>
        </div>
      </div>
    );
  }
  ...
  >
    <div className="bg-gradient-to-br from-white to-green-50 rounded-xl shadow-sm overflow-hidden mb-6 hover:shadow-md transition-shadow border border-green-100">
      <div className="relative w-full h-48">
        ...
        />
        <span
          className={`absolute top-4 left-4 ${getCategoryColor(blog.category)} text-white text-xs px-3 py-1 rounded-full font-medium bg-opacity-80 backdrop-blur-sm`}
        >
          {blog.category}
        </span>
      </div>
                ...
                <form onSubmit={handleSubscribe} className="flex flex-col gap-3" aria-label="Newsletter Subscription">
                  <div className="relative">
                    <input
                      ...
                      } focus:outline-none focus:ring-2 focus:ring-green-300 placeholder-gray-400`}
                  ...
                  <button
                    type="submit"
                    className="bg-white text-[#15803D] px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors border-2 border-white focus:outline-none focus:ring-2 focus:ring-green-300 disabled:opacity-50"
                    disabled={isSubmitting}
