...
const Startup = () => {
  ...
  // Filter blogs by STARTUP and sort by latest
  const startupBlogs = useMemo(
    () =>
      blogs
  ...
  // Featured blog
  const featuredBlog = startupBlogs[0];
          ...
          <div className="md:flex items-center justify-between gap-12">
            <div className="md:w-7/12 mb-10 md:mb-0 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl text-orange-100 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Fuel your entrepreneurial journey with insights, strategies, and stories from the startup world. Explore tips on innovation, funding, scaling, and building a business that disrupts the status quo.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-6">
              ...
              {renderAdSpace('startupSidebar', 'Startup Sidebar')}
              {renderAdSpace('startupTopAd', 'Startup Top')}
              <div className="bg-gradient-to-r from-[#C2410C] to-[#F97316] rounded-xl shadow-sm p-6 text-white mb-6">
                ...
                <form onSubmit={handleSubscribe} className="flex">
                  ...
                  <button
                    type="submit"
                    className="bg-white text-[#C2410C] px-4 py-2 rounded-r-lg font-medium hover:bg-gray-100 transition-colors border-2 border-white focus:outline-none focus:ring-2 focus:ring-white"
                    disabled={isSubmitting}
                  >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex justify-center gap-4">
              <Link
                to="/smallbiz"
                className="bg-[#C2410C] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#B91C1C] transition-colors shadow-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50"
                onClick={() => window.scrollTo(0, 0)}
              >
