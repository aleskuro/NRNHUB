...
// AdSpace Component (aligned with Market.jsx)
...
// BlogCard Component (updated for Global)
...
// FeaturedBlogCard Component (updated for Global)
...
// CompactBlogCard Component (added from Market.jsx)
...
const Global = () => {
  ...
  // Fetch ads on mount
  useEffect(() => {
    console.log('Fetching ads for Global page...');
  ...
  // Debug ad state
  useEffect(() => {
    console.log('Current ads state for Global:', {
      adImages,
      adLinks,
      visibility,
      keyAds: {
  ...
  // Filter blogs
  const { globalBlogs, featuredBlog, suggestedBlogs } = useMemo(() => {
    const filteredGlobalBlogs = blogs
      .filter((blog) => blog.category?.toUpperCase() === 'GLOBAL')
      .sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));

    const globalBlogIds = new Set(filteredGlobalBlogs.map((blog) => blog._id));
    const otherBlogs = blogs
      .filter((blog) => !globalBlogIds.has(blog._id) && blog.category?.toUpperCase() !== 'GLOBAL')
      .sort(() => Math.random() - 0.5)
      .slice(0, 3);

    return {
      globalBlogs: filteredGlobalBlogs,
      featuredBlog: filteredGlobalBlogs[0],
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800">
      <Helmet>
        <link rel="canonical" href="http://localhost:5173/global" />
        <title>Global Blogs | NRNHUB</title>
        <meta
          name="description"
          content="Explore international trends, economies, cultures, and innovations with our global blog."
        />
      </Helmet>
          ...
          <div className="md:flex items-center justify-between gap-12">
            <div className="md:w-7/12 mb-10 md:mb-0 text-center md:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white leading-tight">
                Global <span className="text-purple-200">Blog</span>
              </h1>
              <p className="text-lg md:text-xl text-purple-100 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Stay connected with the world through our global blog, exploring international trends, economies, cultures,
                and innovations. Gain insights into global events and perspectives that shape our interconnected future.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            {!isLoading && !error && globalBlogs.length === 0 && (
              <div className="text-center py-12 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <p className="text-gray-500">Check back later for new global content.</p>
              </div>
            )}
            {!isLoading && !error && globalBlogs.length > 0 && (
              <div className="grid md:grid-cols-2 gap-6">
                {globalBlogs.map((blog) => (
                  <BlogCard
            ...
            <div className="sticky top-6 space-y-8">
              ...
              <div className="bg-gradient-to-r from-[#7734E3] to-[#5E30B2] rounded-xl shadow-sm p-6 text-white">
                ...
                <p className="text-sm mb-4 text-purple-100">
                  Get the latest global trends and insights delivered to your inbox.
                </p>
