      ...
      <div className="space-y-3 text-lg">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="text-gray-600 hover:text-indigo-600 transition duration-300 transform hover:scale-125"
            aria-label="Visit NRNHUB on X"
          >
            <X />
          </a>
          <span className="text-sm text-gray-700">X @NRNHUB</span>
        </div>
...
const BottomSection = () => (
  <div className="border-t border-gray-200 mt-12 pt-6 text-center text-sm text-gray-500 animate-fade-in-up animation-delay-800">
    <NavLink to="/advertisers" onClick={() => window.scrollTo(0, 0)}>
      <span className="relative inline-block mt-6 px-6 py-3 bg-[#883FFF] text-white font-semibold rounded-lg overflow-hidden group shadow-lg transition-all duration-300 hover:bg-red-700">
...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#ffffff] to-[#ffffff] text-gray-800 py-16 overflow-hidden border border-gray-800">
